...
export default class Graph {
    constructor(canvas) {
        ...
        this.grid = {}; //2d objects, where the grid[i][j] is an an object of 
        this.drawGrid();
    }
    ...
    createPath(dataPoints) {
        ...
        this.currentPath = this.addEdge('path', { drawPoints: dataPoints });
    ...
    tick(dataPoints, bool) {
        ...
        if (bool) {
            ...
            // this.currentPath = this.addNode('path', {
            //     draw    
            // })
            ...
            let n_segments = Math.ceil(pathLength / 10);
        ...
        console.log('SelectedPath Length', newPath);
        }
    }
